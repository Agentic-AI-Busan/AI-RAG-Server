...
이 코드를 연구에 활용하셨다면, 아래 내용을 인용해 주세요:

```bibtex
@article{seong2025hybrid,
  title={하이브리드 검색 기반 검색 증강 생성 기술을 활용한 개인 맞춤형 관광 일정 추천 서비스 개발},
  author={성수립 and 조성현},
  journal={2025년 대한전자공학회(IEIE) 추계학술대회 논문집},
  year={2025}
}
```
...
이 프로젝트는 MIT 라이선스를 따릅니다. 자세한 내용은 저장소의 LICENSE 파일을 참고해 주세요.
